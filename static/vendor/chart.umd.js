...
!function (t, e) {
  ...
  class bt {
    ...
    _notify(t, e, i, s) {
      ...
      n.forEach(
        (s) => s({ chart: t, initial: e.initial, numSteps: o, currentStep: Math.min(i - e.start, o) }),
      );
    }
    _refresh() {
 ...
 */ function _t(t) {
  ...
  const ci = (t) => 0 === t || 1 === t,
    ...
    ui = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * O / i) + 1,
      ...
      easeInOutExpo: (t) =>
        ci(t) ? t : t < .5 ? .5 * Math.pow(2, 10 * (2 * t - 1)) : .5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
      easeInCirc: (t) => t >= 1 ? t : -(Math.sqrt(1 - t * t) - 1),
      easeOutCirc: (t) => Math.sqrt(1 - (t -= 1) * t),
      easeInOutCirc: (t) =>
        (t /= .5) < 1 ? -.5 * (Math.sqrt(1 - t * t) - 1) : .5 * (Math.sqrt(1 - (t -= 2) * t) + 1),
  ...
  function Yi(t, e, i, s, n, o) {
    return o || t.isPointInArea(e)
      ? "r" !== i || s ? $i(t, e, i, s, n, o) : function (t, e, i, s) {
        let n = [];
  ...
  class Ns {
    ...
    _update(t) {
      ...
      this.update(t || "default"),
        e._clip = function (t) {
          let e, i, s, n;
          return o(t) ? (e = t.top, i = t.right, s = t.bottom, n = t.left) : e =
            i =
            s =
            n =
              t,
      ...
      if (o) {
        ...
        if (
          a
            ...
            : (t.height = this.maxHeight, t.width = Ks(n) + o), i.display && this.ticks.length
        ) {
      ...
      for (x = 0, _ = l.length; x < _; ++x) {
        ...
        if (
          r
            ...
            : (w = S, O = (1 - C) * D / 2), t.showLabelBackdrop
        ) {
  ...
  class An {
      ...
      if (o) {
        throw new Error(
          "Canvas is already in use. Chart with ID '" + o.id +
            "' must be destroyed before the canvas with ID '" + o.canvas.id + "' can be reused.",
        );
      }
    ...
    get aspectRatio() {
      const { options: { aspectRatio: t, maintainAspectRatio: e }, width: i, height: n, _aspectRatio: o } =
        this;
    ...
    _getUniformDataChanges() {
      ...
      return Array.from(s).map((t) => t.split(",")).map(
    ...
    destroy() {
      ...
      this._stop(),
        ...
        t &&
        (this.unbindEvents(), Te(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null),
        delete Pn[this.id],
  ...
  class $n extends Ns {
    ...
    _updateRadius() {
      const t = this.chart,
        ...
        n = Math.max(s / 2, 0),
        o = (n - Math.max(i.cutoutPercentage ? n / 100 * i.cutoutPercentage : 1, 0)) /
  ...
  var Yn = Object.freeze({
    ...
    BarController: class extends Ns {
      ...
      _calculateBarValuePixels(t) {
        const { _cachedMeta: { vScale: e, _stacked: i, index: n }, options: { base: o, minBarLength: a } } =
            this,
          r = o || 0,
          l = this.getParsed(t),
          h = l._custom,
        ...
        p !== f && (g = p - f, p = f),
          c &&
          (f = h.barStart, p = h.barEnd - h.barStart, 0 !== f && F(f) !== F(h.barEnd) && (g = 0), g += f);
        const m = s(o) || c ? g : o;
  ...
  function eo(t) {
    ...
    return !(t._decimated || t._loop || e.tension || "monotone" === e.cubicInterpolationMode || e.stepped ||
        i)
      ? to
      : Qn;
  }
  ...
  function Ao(t, e) {
    ...
    return !(Re({ x: i, y: s }, e) || Re({ x: i, y: o }, e) || Re({ x: n, y: s }, e) ||
      Re({ x: n, y: o }, e));
  }
  function To(t, e, i) {
  ...
  class No extends Js {
    ...
    _generate() {
      ...
      let d, u, f = e;
      if (
        h && (f = +t.startOf(f, "isoWeek", r)), f = +t.startOf(f, h ? "day" : o), t.diff(i, e, o) > 1e5 * a
  ...
  var Go = {
    ...
    beforeLayout(t, e, i) {
      ...
      const { data: { datasets: s }, options: n } = t.config,
        { elements: o } = n,
        a = Ko(s) || (r = n) && (r.borderColor || r.backgroundColor) || o && Ko(o) ||
